...
def main():
    ...
    home_address = input("Введите долготу и широту адреса дома через запятую: ")
    university_address = input("Введите долготу и широту адреса универсистета через запятую ")
